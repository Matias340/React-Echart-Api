...
function dataFormatter(obj) {
    // prettier-ignore
    let pList = ['dato 1', 'dato 2', 'dato 3', 'dato 4', 'dato 5', 'dato 6', 'dato 7', 'dato 8', 'dato 9', 'dato 10', 'dato 11', 'dato 12', 'dato 13', 'dato 14', 'dato 15', 'dato 16', 'dato 17', 'dato 18', 'dato 19', 'dato 20', 'dato 21', 'dato 22', 'dato 23', 'dato 24', 'dato 25', 'dato 26', 'dato 27', 'dato 28', 'dato 29', 'dato 30', 'dato 31'];
    var temp;
  ...
  const option = {
    baseOption: {
          ...
          '2010-01-01',
          {
            ...
            tooltip: {
              formatter: function (params) {
                return params.name + 'Tabla de Datos';
              }
            },
            symbol: 'diamond',
            symbolSize: 18
      ...
      legend: {
        left: 'right',
        data: ['DATO1', 'DATO2', 'DATO3', 'GDP', 'DATO4', 'DATO5'],
        selected: {
          GDP: true,
          DATO4: false,
          DATO5: false,
    ...
    options: [
      {
        ...
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2002sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2002sum'] },
              { name: 'Stats', value: dataMap.dataTI['2002sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2003 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2003sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2003sum'] },
              { name: 'Stats', value: dataMap.dataTI['2003sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2004 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2004sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2004sum'] },
              { name: 'Stats', value: dataMap.dataTI['2004sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2005 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2005sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2005sum'] },
              { name: 'Stats', value: dataMap.dataTI['2005sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2006 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2006sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2006sum'] },
              { name: 'stats', value: dataMap.dataTI['2006sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2007 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2007sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2007sum'] },
              { name: 'Stats', value: dataMap.dataTI['2007sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2008 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2008sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2008sum'] },
              { name: 'Stats', value: dataMap.dataTI['2008sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2009 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2009sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2009sum'] },
              { name: 'Stats', value: dataMap.dataTI['2009sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2010 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2010sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2010sum'] },
              { name: 'Stats', value: dataMap.dataTI['2010sum'] }
            ]
          }
        ]
      },
      {
        title: { text: '2011 Resultados' },
        series: [
          ...
          {
            data: [
              { name: 'Valores', value: dataMap.dataPI['2011sum'] },
              { name: 'Resultados', value: dataMap.dataSI['2011sum'] },
              { name: 'Stats', value: dataMap.dataTI['2011sum'] }
            ]
          }
        ]
      }
...
function DataFormatter() {
  ...
  return (
    <div>
        <ReactEcharts
         option={option}
         style={{ marginBottom:"80px", marginTop: "100px" , width: "1340px", height: "500px" }}/> 
    </div>
  )
}
